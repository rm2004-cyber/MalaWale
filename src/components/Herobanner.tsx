  ...
  return (
    <section className="relative w-full overflow-hidden" style={{ height: "clamp(220px, 52vw, 520px)", background: "#1a0a00" }}>
      ...
      <div className="absolute inset-0 flex flex-col justify-center px-10 md:px-20 z-10">
        <span className="text-[#d4a373] uppercase tracking-[0.2em] text-xs font-serif italic mb-2 border border-[#d4a373]/30 px-3 py-1 w-fit">
          {slide.tag || "DIVINE COLLECTION"}
        </span>
        <h1 className="text-4xl md:text-6xl font-bold text-[#fff9f2] mb-4 font-serif">
          {slide.title}
        </h1>
        ...
        <a 
          ...
          className="bg-[#8b4513] text-white px-8 py-3 w-fit font-medium uppercase tracking-widest text-sm rounded-sm hover:bg-[#a0522d] transition-colors"
        >
          Explore {slide.categoryLink?.name || "Collection"}
        </a>
      </div>

      <div className="absolute bottom-6 left-10 text-[#d4a373] font-serif text-lg z-20">
