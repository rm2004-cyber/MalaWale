...
const PhoneIcon = () => (
  <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <path d="M3.05 4.11a1 1 0 011.41-.07l2.83 2.45a1 1 0 01.11 1.37l-1.1 1.45a9.1 9.1 0 004.36 4.36l1.45-1.1a1 1 0 011.37.11l2.45 2.83a1 1 0 01-.07 1.41l-1.56 1.44A2 2 0 0112.5 18C7.25 18 2 12.75 2 7.5a2 2 0 01.6-1.44L3.05 4.1z"
      stroke="#D4AF37" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" fill="none" />
  </svg>
);
const EmailIcon = () => (
  <svg width="16" height="16" viewBox="0 0 20 20" fill="none" aria-hidden="true">
    <rect x="2" y="4" width="16" height="12" rx="2" stroke="#D4AF37" strokeWidth="1.4" />
    <path d="M2 7l8 5 8-5" stroke="#D4AF37" strokeWidth="1.4" strokeLinecap="round" />
  </svg>
);
const LocationIcon = () => (
  <svg width="16" height="16" viewBox="0 0 20 20" fill="none" aria-hidden="true">
    <path d="M10 2a6 6 0 016 6c0 4-6 10-6 10S4 12 4 8a6 6 0 016-6z" stroke="#D4AF37" strokeWidth="1.4" strokeLinejoin="round" />
    <circle cx="10" cy="8" r="2" stroke="#D4AF37" strokeWidth="1.4" />
  </svg>
);
const WhatsAppIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
    <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z" fill="#D4AF37" fillOpacity="0.85" />
...
const Asterism = ({ size = 14 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 14 14" fill="none" aria-hidden="true">
    <path d="M7 1 L7.9 5.6 L12 3 L9.4 7.1 L14 8 L9.4 8.9 L12 13 L7.9 10.4 L7 15 L6.1 10.4 L2 13 L4.6 8.9 L0 8 L4.6 7.1 L2 3 L6.1 5.6 Z" fill="#D4AF37" />
  </svg>
);
...
const ColHeading = ({ children }: { children: React.ReactNode }) => (
  <h3 className="mb-5 uppercase tracking-widest" style={{
    ...
    color: "#D4AF37", letterSpacing: "0.26em", fontWeight: 600,
  }}>
    {children}
  </h3>
);
  ...
  <motion.div variants={columnVariants} className="flex flex-col">
    ...
    <div className="mb-3">
      <h2 className="leading-none" style={{
        ...
        color: "#FCF8F2", letterSpacing: "0.12em",
      }}>MALA WALE</h2>
      <p className="mt-1" style={{
        fontFamily: "'Cormorant Garamond', serif", fontSize: "0.88rem",
        color: "#D4AF37", letterSpacing: "0.16em", fontStyle: "italic",
    ...
    <div className="flex items-center gap-3 mt-auto">
      {(["FB", "IG", "YT", "WA"] as const).map((s) => (
        <motion.a key={s} href="#" aria-label={s} whileHover={{ scale: 1.12, y: -2 }} whileTap={{ scale: 0.95 }}
          ...
          style={{ background: "rgba(212, 175, 55,0.12)", border: "1px solid rgba(212, 175, 55,0.3)", color: "#D4AF37", fontFamily: "'Jost', sans-serif", fontSize: "0.62rem", letterSpacing: "0.05em" }}>
          {s}
        </motion.a>
      ))}
    </div>
          ...
          {displayLinks.map((link) => (
            <li key={link.label}>
              ...
              >
                ...
                />
                <motion.span variants={{ rest: { color: "rgba(255,249,242,0.72)" }, hover: { color: "#D4AF37" } }}>
                  {link.label}
                </motion.span>
              </motion.a>
            </li>
  ...
  return (
    <motion.div variants={columnVariants} className="flex flex-col">
        ...
        {contactItems.map((item) => (
          <li key={item.label}>
            <motion.a href={item.href} whileHover={{ x: 4 }} transition={{ duration: 0.2 }}
              ...
              <div>
                <p className="leading-none mb-1" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "0.7rem", color: "#D4AF37", letterSpacing: "0.14em", textTransform: "uppercase" }}>
                  {item.label}
                </p>
      ...
      <div className="flex items-center gap-2.5 px-3 py-2.5 rounded-xl mt-1"
        ...
        <div>
          <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "0.7rem", color: "#D4AF37", letterSpacing: "0.12em", textTransform: "uppercase" }}>Workshop Hours</p>
...
const FeedbackColumn = () => {
  ...
  const inputStyle = (field: string): React.CSSProperties => ({
    fontFamily: "'Jost', sans-serif", fontSize: "0.875rem", color: "#FCF8F2",
    background: "rgba(255,249,242,0.05)",
    border: `1px solid ${focused === field ? "rgba(212, 175, 55,0.7)" : "rgba(212, 175, 55,0.2)"}`,
      ...
      <AnimatePresence mode="wait">
        {submitted ? (
          <motion.div key="success" initial={{ opacity: 0, scale: 0.88, y: 10 }} animate={{ opacity: 1, scale: 1, y: 0 }}
            ...
            <div className="text-3xl mb-3" style={{ filter: "drop-shadow(0 0 8px rgba(212, 175, 55,0.5))" }}>🙏</div>
            <p style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.05rem", color: "#D4AF37" }}>Dhanyavaad!</p>
          ...
          <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.button type="button" onClick={() => handleSubmit()}
              ...
              style={{
                ...
                background: isSubmitting ? "rgba(200,132,58,0.45)" : "linear-gradient(135deg, #E65100 0%, #D84315 100%)",
                color: "#FCF8F2", border: "1px solid rgba(212, 175, 55,0.35)",
              ...
              {isSubmitting ? (
                ...
                <><span>Submit Feedback</span><span style={{ color: "#D4AF37", fontSize: "0.8rem" }}>✦</span></>
              )}
            </motion.button>
...
const TrustBanner = ({ inView }: { inView: boolean }) => (
  <motion.div variants={trustBannerVariants} initial="hidden" animate={inView ? "visible" : "hidden"}
    ...
    style={{ background: "linear-gradient(135deg, rgba(212, 175, 55,0.10) 0%, rgba(155, 27, 27,0.25) 100%)", border: "1px solid rgba(212, 175, 55,0.28)", boxShadow: "0 2px 24px rgba(0,0,0,0.15), inset 0 1px 0 rgba(212, 175, 55,0.12)" }}>
    <div className="flex-shrink-0 flex items-center justify-center w-12 h-12 rounded-xl"
      style={{ background: "rgba(212, 175, 55,0.12)", border: "1px solid rgba(212, 175, 55,0.3)", fontSize: "1.5rem" }}>🏭</div>
    <div className="flex-1">
      <p className="mb-1" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "0.7rem", color: "#D4AF37", letterSpacing: "0.22em", textTransform: "uppercase", fontWeight: 600 }}>
      ...
      <p style={{ fontFamily: "'Jost', sans-serif", fontSize: "0.875rem", color: "rgba(255,249,242,0.8)", lineHeight: 1.6, letterSpacing: "0.01em" }}>
        <strong style={{ color: "#D4AF37" }}>100% genuine products</strong> constructed directly from raw woods and pure stones. Crafted carefully inside{" "}
        <em style={{ color: "#FCF8F2" }}>Sanwariya Handicraft</em> units — without a single third-party distributor, ever.
      </p>
    </div>
  </motion.div>
);
...
const Footer: React.FC<FooterProps> = ({ onCategorySelect }) => {
  ...
  return (
    <footer ref={footerRef} aria-label="MalaWale site footer" className="relative w-full overflow-hidden" style={{ background: "#9B1B1B" }}>
      <div className="w-full" style={{ height: "5px", background: "linear-gradient(90deg, transparent 0%, #D4AF37 20%, #f0c880 50%, #D4AF37 80%, transparent 100%)" }} />
      <div className="w-full" style={{ height: "1px", background: "rgba(212, 175, 55,0.18)" }} />

      {/* Ambient glows */}
      <div className="pointer-events-none absolute inset-0" style={{ backgroundImage: "radial-gradient(ellipse 60% 50% at 15% 30%, rgba(212, 175, 55,0.07) 0%, transparent 65%), radial-gradient(ellipse 50% 60% at 85% 70%, rgba(160,82,45,0.18) 0%, transparent 65%)" }} />
      {/* OM watermark */}
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center select-none overflow-hidden">
        <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(14rem, 30vw, 28rem)", color: "rgba(212, 175, 55,0.045)", lineHeight: 1, userSelect: "none", transform: "translateY(8%)" }}>ॐ</span>
      </div>
      {/* Dot grid */}
      <div className="pointer-events-none absolute inset-0 opacity-[0.025]" style={{ backgroundImage: "radial-gradient(circle, #D4AF37 1px, transparent 1px)", backgroundSize: "28px 28px" }} />
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-8 lg:px-14 pt-14 pb-8">
        ...
        <div className="w-full my-10" style={{ height: "1px", background: "rgba(212, 175, 55,0.18)" }} />
        <TrustBanner inView={inView} />
        <div className="w-full mt-8 mb-6" style={{ height: "1px", background: "rgba(212, 175, 55,0.14)" }} />
        ...
        <motion.div initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : { opacity: 0 }} transition={{ delay: 0.9, duration: 0.6 }}
          ...
          <div className="flex items-center gap-2">
            <Asterism size={10} />
            <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "0.82rem", color: "rgba(212, 175, 55,0.85)", fontStyle: "italic", letterSpacing: "0.05em" }}>
              Crafted with Devotion · Delivered with Blessings
            </p>
            <Asterism size={10} />
          </div>
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-full" style={{ background: "rgba(212, 175, 55,0.10)", border: "1px solid rgba(212, 175, 55,0.22)" }}>
